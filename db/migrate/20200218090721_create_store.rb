class CreateStore < ActiveRecord::Migration[5.2]
  def change
    create_table :stores do |t|
      ...
      t.bigint :bank,null: false, default: 0
      t.bigint :grand_total_before,null: false, default: 0
      t.bigint :modals_before,null: false, default: 0
      t.bigint :grand_total_card_before,null: false, default: 0
      t.bigint :store_balances,null: false, default: 0

      t.timestamps
    end
    
    add_reference :users, :store, null: false, default: 1
  end
end
